## Optimal change application

The function returns a string describing the optimal change which follows the following convention:
...
It contains unit tests. To run it locally, use the command.
